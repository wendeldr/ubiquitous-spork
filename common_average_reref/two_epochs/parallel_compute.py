...
# Absolute paths
NPY_DIR = Path('/media/dan/Data/git/ubiquitous-spork/common_average_reref/two_epochs/run_data/npy')
OUTPUT_DIR = Path('/media/dan/Data/git/ubiquitous-spork/common_average_reref/two_epochs/run_data/outputs')
CONFIG_FILE = Path('/media/dan/Data/git/ubiquitous-spork/common_average_reref/two_epochs/selected_config.yaml')
